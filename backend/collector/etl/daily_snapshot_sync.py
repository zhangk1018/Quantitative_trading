    ...
    try:
        ...
        upsert_sql = text("""
            INSERT INTO stock_daily_snapshot (
                ...
                ema5, ema10, ema20, ema60, atr, kdj_k, kdj_d, kdj_j,
            ...
            SELECT
                ...
                ROUND(i.ema5::numeric, 2) AS ema5,
                ROUND(i.ema10::numeric, 2) AS ema10,
                ROUND(i.ema20::numeric, 2) AS ema20,
                ROUND(i.ema60::numeric, 2) AS ema60,
                ROUND(i.atr::numeric, 4) AS atr,
                ROUND(i.kdj_k::numeric, 2) AS kdj_k,
                ROUND(i.kdj_d::numeric, 2) AS kdj_d,
                ROUND(i.kdj_j::numeric, 2) AS kdj_j,
